    ...
    <div className='blog-list-item'>
      ...
      <div className='blog-list-item-operation'>
        <svg
          aria-hidden='true'
          role='img'
          class='blog-list-item-operation-icon'
          width='12px'
          height='12px'
        ...
        <span className='blog-list-item-operation-span'>
        ...
        <span className='blog-list-item-operation-span'>{item.look_number}</span>
        ...
        <span className='blog-list-item-operation-span'>{item.commentCount}</span>
        ...
        <svg
          ...
          x-show='liked(55)'
          data-icon='mdi:heart'
          style={{ color: item.isLiked ? 'rgb(185, 28, 28)' : '#bbb' }}
        >
          <path
            fill='currentColor'
        ...
        <span
          className='blog-list-item-operation-span'
          style={{ color: item.isLiked ? 'rgb(185, 28, 28)' : '#bbb' }}
        >
          {item.likeCount}
        </span>
        ...
        {((item.tags && JSON.parse(item.tags)) || []).map(tag => (
          <span
            className='blog-list-item-operation-tag'
            key={tag.id}
